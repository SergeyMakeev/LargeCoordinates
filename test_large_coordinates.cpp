...
void test_to_float3_bounds() {
    std::cout << "Testing to_float3() bounds assertion..." << std::endl;
    ...
    std::cout << "PASS: to_float3() bounds assertion tests passed" << std::endl;
}
